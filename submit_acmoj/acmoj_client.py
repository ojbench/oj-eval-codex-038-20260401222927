...
2. Submit C++ code (single file):
   python3 acmoj_client.py --token ${ACMOJ_TOKEN} submit-code --problem-id ${ACMOJ_PROBLEM_ID} --file path/to/main.cpp [--language cpp]
   If omitted, language defaults to cpp
...
def main():
    ...
    submit_code_parser = subparsers.add_parser("submit-code", help="Submit code text (single file)")
